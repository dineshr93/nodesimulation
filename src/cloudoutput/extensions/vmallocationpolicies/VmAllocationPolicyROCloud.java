...
public class VmAllocationPolicyROCloud extends VmAllocationPolicySimple implements VmAllocationPolicyExtensible {

    private double upperUtilizationThreshold;
    
          
    public VmAllocationPolicyROCloud(List<? extends PowerHost> list, double utilizationThreshold) {
        super(list);
