...
import cloudoutput.extensions.brokers.RoundRobinDatacenterBroker;
...
public enum BrokerPolicy implements Serializable {
    ...
    public static BrokerPolicy getInstance(String alias) {
        if(alias.equals("n version")) return BrokerPolicy.ROUND_ROBIN;
    ...
    public static String[] getBrokerPoliciesNames() {
        String[] nativePolicies = new String[] {"Round robin","n version"};
