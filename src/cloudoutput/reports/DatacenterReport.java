...
import cloudoutput.dao.MigrationDAO;
import cloudoutput.dao.ReportDataDAO;
...
class DatacenterReport {
    ...
    private void generateHtml() throws IOException, URISyntaxException {
        this.html = FileIO.readStringFromResource("cloudoutput/gui/reports/resources/datacenter");
        ...
        for(Integer hostId : hostIds) {
            ...
            String resHtml = FileIO.readStringFromResource("cloudoutput/gui/reports/resources/host_resource_utilization");
            ...
            String powerHtml = FileIO.readStringFromResource("cloudoutput/gui/reports/resources/host_power_consumption");
