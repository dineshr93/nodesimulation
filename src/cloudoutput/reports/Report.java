...
public class Report {
	...
	private static void createHtmlDirectoryTree() throws URISyntaxException, IOException {
        ...
        tempDir.mkdir();
        String tempString = FileIO.readStringFromResource("cloudoutput/gui/reports/resources/css/style.css");
        ...
        tempDir.mkdir();
        String[] tempFilesArray = FileIO.getResourceListing(Images.class, "cloudoutput/gui/reports/resources/images/");
        for(String tempFile : tempFilesArray) {
            if (tempFile.isEmpty()) continue;
            byte[] tempBytes = FileIO.readBytesFromFile("cloudoutput/gui/reports/resources/images/" + tempFile);
        ...
        tempDir.mkdir();
        tempFilesArray = FileIO.getResourceListing(JS.class, "cloudoutput/gui/reports/resources/js/");
        for(String tempFile : tempFilesArray) {
            if (tempFile.isEmpty()) continue;
            tempString = FileIO.readStringFromResource("cloudoutput/gui/reports/resources/js/" + tempFile);
    ...
    private static void createOverallReport(List<PowerDatacenter> datacentersList, List<DatacenterBroker> brokersList, 
                                            ElapsedTime elapsedTime) throws IOException, URISyntaxException {
        String html = FileIO.readStringFromResource("cloudoutput/gui/reports/resources/index.html");
    ...
    private static void createDatacentersReports(List<PowerDatacenter> datacentersList,
    	...
    	if(htmlReportsEnabled) {    		
	    	String html = FileIO.readStringFromResource("cloudoutput/gui/reports/resources/datacenters.html");	        
    ...
    private static void createCustomersReports(List<DatacenterBroker> brokersList) throws IOException, URISyntaxException {
        ...
        if(htmlReportsEnabled) {
        	String html = FileIO.readStringFromResource("cloudoutput/gui/reports/resources/customers.html");
