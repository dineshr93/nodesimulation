...
class CustomerReport {
    ...
    private void generateHtml() throws IOException, URISyntaxException {
        this.html = FileIO.readStringFromResource("cloudoutput/gui/reports/resources/customer");
        ...
        for(Integer vmId : vmIds) {
            ...
            String resHtml = FileIO.readStringFromResource("cloudoutput/gui/reports/resources/vm_resource_utilization");
