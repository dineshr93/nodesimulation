...
public class Dialog {
    ...
    public static void showWarning(Component parent, String message) {
        JOptionPane.showMessageDialog(parent, 
                                     ...
                                     new javax.swing.ImageIcon(ImageIcon.class.getResource("/cloudoutput/gui/resources/warning.png")));
    }
    ...
    public static void showInfo(Component parent, String message) {
        JOptionPane.showMessageDialog(parent,
                                     ...
                                     "Information",
                                     JOptionPane.INFORMATION_MESSAGE,
                                     new javax.swing.ImageIcon(ImageIcon.class.getResource("/cloudoutput/gui/resources/biginfo.png")));
    }
    ...
    public static void showErrorMessage(Component parent, String message) {
        JOptionPane.showMessageDialog(parent,
                                     ...
                                     new javax.swing.ImageIcon(ImageIcon.class.getResource("/cloudoutput/gui/resources/error.png")));
    }    
    ...
    public static void showSuccessMessage(Component parent, String message) {
        JOptionPane.showMessageDialog(parent,
                                     ...
                                     "Information",
                                     JOptionPane.INFORMATION_MESSAGE,
                                     new javax.swing.ImageIcon(ImageIcon.class.getResource("/cloudoutput/gui/resources/success.png")));
    }
    ...
    public static int showQuestionDialog(Component parent, String title, String question) {
        ...
        int n = JOptionPane.showOptionDialog(parent,
            ...
            new javax.swing.ImageIcon(ImageIcon.class.getResource("/cloudoutput/gui/resources/question.png")),
            options,
            options[0]);
