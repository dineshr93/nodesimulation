...
package cloudoutput.gui.reports.resources.js;

/**
 * This is a helper class used to retrieve javascript files from a .jar file.
 * Its only purpose is to indicate the location of the javascript files, thus
