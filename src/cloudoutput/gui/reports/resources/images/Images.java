...
package cloudoutput.gui.reports.resources.images;

/**
 * This is a helper class used to retrieve images from a .jar file.
 * Its only purpose is to indicate the location of the image files, thus there's
